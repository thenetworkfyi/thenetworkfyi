...
SimMessageMetaFactory = Callable[[], "SimMessageMeta | None"]
...
class _PostOfficeSMTP:
    def __init__(
        ...
        meta_factory: SimMessageMetaFactory | None = None,
    ) -> None:
    ...
    def send_message(self, message: EmailMessage) -> None:
        meta = (
            self.meta_factory() if self.meta_factory is not None else self.default_meta
        )
        self.post_office.deliver(message, meta)
...
def capture_outbound(
    ...
    *,
    ...
    """
    if meta is not None and meta_factory is not None:
        raise ValueError("meta and meta_factory are mutually exclusive")
    smtp = _PostOfficeSMTP(post_office, meta, meta_factory)
    with (
