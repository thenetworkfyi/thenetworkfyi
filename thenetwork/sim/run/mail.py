...
# after ``_redact_message`` replaces multipart boundaries.  Every other header
# is mail content and must pass through the log redactor before a public mbox
# is written.
